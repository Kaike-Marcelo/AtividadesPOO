...
public class menorDe50NumerosEntre1e100 {

    private int numeroReferencia;

    public void salvarMenorNumero(int numero){
    ...
    public static void main(String[] args){
        ...
        menorDe50NumerosEntre1e100 descobrir = new menorDe50NumerosEntre1e100();
        ...
        for( int i=0; i<51; i++ ){
            ...
            descobrir.salvarMenorNumero(numero);
            loop = true;
